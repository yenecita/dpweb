...
<!-- ROW PARA FILA-->
    <div class="container-fluid row m-0 p-0">
        ...
        <div class="col-md-4 col-sm-6 row m-0 p-0 " style="height: 300px; background-color:blue">
            <div class="col-md-4" style="height: 100px; background-color:#c4271f"></div>
            <div class="col-md-4" style="height: 100px; background-color:#22c41f" ></div>
            <div class="col-md-4"style="height:  100px; background-color:#ea900e" ></div>
